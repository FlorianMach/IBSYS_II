...
export class ProcurementComponent implements OnInit {
  ...
  onlyOneValue(e) {
    ...
    if(e.target.id == "orderE" && e.target.name == "order1"){
      this.outputData.item21.orderN = false;
      this.outputData.item21.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order2"){
      this.outputData.item22.orderN = false;
      this.outputData.item22.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order3"){
      this.outputData.item23.orderN = false;
      this.outputData.item23.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order4"){
      this.outputData.item24.orderN = false;
      this.outputData.item24.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order5"){
      this.outputData.item25.orderN = false;
      this.outputData.item25.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order6"){
      this.outputData.item27.orderN = false;
      this.outputData.item27.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order7"){
      this.outputData.item28.orderN = false;
      this.outputData.item28.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order8"){
      this.outputData.item32.orderN = false;
      this.outputData.item32.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order9"){
      this.outputData.item33.orderN = false;
      this.outputData.item33.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order10"){
      this.outputData.item34.orderN = false;
      this.outputData.item34.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order11"){
      this.outputData.item35.orderN = false;
      this.outputData.item35.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order12"){
      this.outputData.item36.orderN = false;
      this.outputData.item36.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order13"){
      this.outputData.item37.orderN = false;
      this.outputData.item37.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order14"){
      this.outputData.item38.orderN = false;
      this.outputData.item38.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order15"){
      this.outputData.item39.orderN = false;
      this.outputData.item39.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order16"){
      this.outputData.item40.orderN = false;
      this.outputData.item40.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order17"){
      this.outputData.item41.orderN = false;
      this.outputData.item41.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order18"){
      this.outputData.item42.orderN = false;
      this.outputData.item42.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order19"){
      this.outputData.item43.orderN = false;
      this.outputData.item43.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order20"){
      this.outputData.item44.orderN = false;
      this.outputData.item44.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order21"){
      this.outputData.item45.orderN = false;
      this.outputData.item45.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order23"){
      this.outputData.item46.orderN = false;
      this.outputData.item46.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order24"){
      this.outputData.item47.orderN = false;
      this.outputData.item47.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order25"){
      this.outputData.item48.orderN = false;
      this.outputData.item48.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order26"){
      this.outputData.item52.orderN = false;
      this.outputData.item52.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order27"){
      this.outputData.item53.orderN = false;
      this.outputData.item53.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order28"){
      this.outputData.item57.orderN = false;
      this.outputData.item57.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order29"){
      this.outputData.item58.orderN = false;
      this.outputData.item58.orderE = true;
    }else if(e.target.id == "orderE" && e.target.name == "order30"){
      this.outputData.item59.orderN = false;
      this.outputData.item59.orderE = true;
    }
  }
}
